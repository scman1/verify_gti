...
##print("2. Add Borders")
##borders_dir = Path(Path().absolute().parent, "herbariumsheets","nmw","batch_3", "withborders")
...
manualedit_dir = Path(Path().absolute().parent, "herbariumsheets","nmw","nmw_full_set")
...
finished_dir = Path(Path().absolute().parent, "herbariumsheets","nmw","nmw_final_pass")
