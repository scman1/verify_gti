...
source_dir = Path(Path().absolute().parent, "herbariumsheets","nmw","batch_1")
# Directory for processing and verifying the new set of segmented images
work_dir = Path(Path().absolute().parent, "herbariumsheets","nmw","batch_1", "to_process")
...
print("2. Add Borders")
borders_dir = Path(Path().absolute().parent, "herbariumsheets","nmw","batch_1", "withborders")
...
resize_dir = Path(Path().absolute().parent, "herbariumsheets","nmw","batch_1", "resized")
...
manualedit_dir = Path(Path().absolute().parent, "herbariumsheets","nmw","batch_1", "manualedit")
...
finished_dir = Path(Path().absolute().parent, "herbariumsheets","nmw","batch_1", "finalpass")
...
print("6.3 instance-label match")
